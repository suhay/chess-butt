...
// 1020 / 1024
namespace ChessButt2_Copy  // #DEBUG
{  // #DEBUG
  ...
  public class MyBot : IChessBot
  {
    ...
    int DeltaCutoff = 3790; // #DEBUG
    int MobilityWeight = 11; // #DEBUG

    int FullDepthMoves = 9; // #DEBUG
    int ReductionLimit = 2; // #DEBUG

    int R = 1; // #DEBUG

    int Panic = 12154; // #DEBUG
    int PanicD = 2; // #DEBUG  2 prevented all over tines, but was slightly worse

    int LateGamePly = 67; // #DEBUG

    int TMax = 4417077;  // #DEBUG
